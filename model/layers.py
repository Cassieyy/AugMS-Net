...
class Dynamic_conv3d(nn.Module):
    def __init__(self, in_planes, out_planes, kernel_size, ratio=0.25, stride=1, padding=1, dilation=1, groups=1, bias=False, K=4, temperature=34):
...
if __name__ == "__main__":
    ...
    model = Dynamic_conv3d(1, 1, 3).to(device)
    ...
    img = torch.randn(1, 1, 19, 256, 256).to(device)
    output = model(img)
    print(output.shape)
