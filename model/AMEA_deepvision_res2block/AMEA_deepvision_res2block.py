...
class AMEA_deepvision_res2block(nn.Module):
    def __init__(self, in_ch, out_ch, scale):
        ...
        self.conv1 = downDouble3dConv(64, 128, scale)
        self.pool2 = nn.MaxPool3d((1,2,2), (1,2,2))
        self.conv2 = downDouble3dConv(128, 256, scale)
        self.pool3 = nn.MaxPool3d((1,2,2), (1,2,2))
        
        self.bridge = downDouble3dConv(256, 512, scale)
        ...
        self.conv4 = upDouble3dConv(768, 256, scale)
        self.up2 = nn.ConvTranspose3d(256, 256, (1,2,2), stride=(1,2,2)) 
        self.conv5 = upDouble3dConv(384, 128, scale)
        self.up3 = nn.ConvTranspose3d(128, 128, (1,2,2), stride=(1,2,2)) ##
        self.conv6 = upDouble3dConv(192, 64, scale)
...
if __name__ == "__main__":
    ...
    model = AMEA_deepvision_res2block(1, 1, scale=32).cuda()
